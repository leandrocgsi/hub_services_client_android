...
import br.com.erudio.simplecrud.config.ApiConstants;
import br.com.erudio.simplecrud.model.Hero;
import br.com.erudio.simplecrud.repository.RequestHandler;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createHero() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(ApiConstants.URL_CREATE_HERO, params, CODE_POST_REQUEST);
        request.execute();
    }

    private void readHeroes() {
        PerformNetworkRequest request = new PerformNetworkRequest(ApiConstants.URL_READ_HEROES, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void updateHero() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(ApiConstants.URL_UPDATE_HERO, params, CODE_POST_REQUEST);
        request.execute();
    ...
    private void deleteHero(int id) {
        PerformNetworkRequest request = new PerformNetworkRequest(ApiConstants.URL_DELETE_HERO + id, null, CODE_GET_REQUEST);
        request.execute();
    }
